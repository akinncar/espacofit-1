...
public class TelaBuscaPersonal extends javax.swing.JDialog {
   ...
   @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NOME", "RG", "CPF", "DATA NASCIMENTO", "CEP", "TELEFONES", "OBSERVAÇÕES"
            }
        ));
   ...
   public static void main(String args[]) {
      ...
      try {
         ...
         java.util.logging.Logger.getLogger(TelaBuscaPersonal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
      ...
      java.awt.EventQueue.invokeLater(new Runnable() {
         public void run() {
            TelaBuscaPersonal dialog = new TelaBuscaPersonal(new javax.swing.JFrame(), true);
