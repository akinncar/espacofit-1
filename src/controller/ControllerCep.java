...
import controller.ControllerBcep;
...
public class ControllerCep implements ActionListener {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(e.getSource() == tela.getCancelar()){
         ...
         tela.getListaBairros().setSelectedIndex(0);
         tela.getListaCidade().setSelectedItem(" - ");
         tela.getListaCidade().setSelectedIndex(0);
         LimpaEstadoComponentes(false);
      }
      ...
      if(e.getSource() == tela.getGravar()){
         ...
         for(Cidade cidade : CidadeService.Listar()){
            ...
            System.out.println(tela.getListaCidade().getSelectedItem());
      ...
      if(e.getSource() == tela.getBuscar()){
            view.TelaBuscaCep telaBusca = new TelaBuscaCep(null, true);
